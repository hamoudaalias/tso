...
2. **Cohérence longue-distance :** La dérive sémantique montre que l'état LIF explore l'espace des concepts, mais sans mécanisme de planification. L'ajout d'une mémoire de travail (une fenêtre glissante de mots émis) pourrait contraindre la génération à rester cohérente sur de plus longues séquences.
